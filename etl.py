...
def process_song_file(cur, filepath):
    """ 
    Extract Data for Songs Table And Artists Table
...
def process_log_file(cur, filepath):
    """
    perform ETL on the second dataset,
    log_data, to create the time and users dimensional tables,
...
def process_data(cur, conn, filepath, func):
    """
    get the song ID and artist ID by querying the songs and artists tables to find matches based on song title,
